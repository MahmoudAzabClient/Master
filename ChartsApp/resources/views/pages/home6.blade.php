        ...
        <div class="col-xl-12">
            ...
            <div class="card">
                ...
                <div class="card-header pb-0">
                    <form action="{{route('search6', ['id' => $branch->id])}}" method="POST" role="search" autocomplete="off">
                            {{ csrf_field() }}
                            <div class="row">
                ...
                <div class="card-body">
                <h2 style="text-align:center"><a href="{{ url('home3')}}/">{{ $branch->ps_name1 }} </a></h2>                <div class="card-body">
